...
<a href="https://davidwise01.github.io/gravity-bracket/" style="flex:1 1 210px;text-decoration:none;background:#0b0f18;border:1px solid #6fb8e0;border-left:3px solid #6fb8e0;border-radius:5px;padding:13px 15px"><div style="font-family:monospace;font-size:16px;font-weight:700;color:#6fb8e0">{{ G [ s | a | q ] G }}</div><div style="font-family:monospace;font-size:9.5px;color:#8fa3b8;margin:5px 0 6px;text-transform:uppercase;letter-spacing:.06em">The Gravity Bracket · the frame</div><div style="font-size:13px;color:#9aaabd;line-height:1.5">gravity bookends the stack at both ends of scale</div><div style="font-family:monospace;font-size:9px;color:#6fb8e0;margin-top:7px">▸ you are here</div></a>
